...
class Model:
    ...
    def dump(self):
        ...
        #Create a path
        filepath=os.path.join("models",f"{timestamp}_credit_risk.pkl")
    ...
    def load(self):
        ...
        """
        #create search path
        search_path = os.path.join("models", "*credit_risk*.pkl")
...
class ModelBuilder:
    ...
    def make_cnf_matrix(self,threshold):
        ...
        #return Confusion matrix heatmap ,classification_report and ROC-AUC score
        return fig,fig_report,Roc
    ...
    def make_predictions(self):
        ...
        prediction=self.model.fitted_model.predict(self.X_test)
